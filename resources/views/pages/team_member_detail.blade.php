                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>{{ ADDRESS }}</td>
                            <td>
                                {!! clean(nl2br($team_member_detail->address)) !!}
                            </td>
                        </tr>
                        <tr>
                            <td>{{ EMAIL_ADDRESS }}</td>
            ...
            <div class="col-md-12">
                ...
                <div class="description mt_30">
                    <ul class="nav nav-pills mb-3 nav-doctor" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="pills-tab-2" data-toggle="pill" href="#pills-t-2" role="tab" aria-controls="pills-t-2" aria-selected="false">{{ DETAIL }}</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content nav-doctor-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-t-1" role="tabpanel" aria-labelledby="pills-tab-1">
                            ...
                            {{ NO_CONTENT_FOUND }}
                            @else
                                {!! clean($team_member_detail->degree) !!}
							@endif
                        </div>
