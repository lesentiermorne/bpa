                                                                ...
                                                                <div class="shipping-checkbox-container">
                                                                    ...
                                                                    <input class="form-check-input" type="radio" name="shipping_id" id="shipping_radio_{{ $i }}" value="{{ $row->id }}" {{ $chk }}>
                                                                        <label class="form-check-label" for="shipping_radio_{{ $i }}">
                                                                            ...
                                                                            <div class="subheading">({!! clean(nl2br($row->shipping_text)) !!})</div>
                                                                        </label>
                                                                    </div>
                                                                </div>
                    ...
                    <form action="{{ route('customer.login_from_checkout_page.store') }}" method="post">
                        ...
                        <div class="customer-info mb_30">                       
                            ...
                            <div class="returning-customer-login-section d_n">
                                ...
                                <div class="row mb_10">
                                    <div class="col">
                                        <input type="text" class="form-control" placeholder="{{ EMAIL_ADDRESS }}" name="customer_email">
                                    </div>
                                    <div class="col">
                    ...
                    <form action="{{ route('customer.billing_shipping_submit') }}" method="post">
                        ...
                        <div class="row mb_10">
                            <div class="col">
                                ...
                                @endif
                                <input type="text" class="form-control" placeholder="{{ PHONE_NUMBER }}" name="billing_phone" value="{{ $temp_var }}">
                            </div>
                            <div class="col">
                        ...
                        <div class="shipping-info mt_15 @if(session()->get('name_click_shipping_same_check')) d_b @else d_n @endif">
                            ...
                            <div class="row mb_10">
                                <div class="col">
                                    ...
                                    @php $temp_var = session()->get('customer_phone') @endphp
                                    @endif
                                    <input type="text" class="form-control" placeholder="{{ PHONE_NUMBER }}" name="shipping_phone" value="{{ $temp_var }}">
                                </div>
                                <div class="col">
                        ...
                        <div class="row mb_10">
                            <div class="col">
                                ...
                                @php $temp_var = '' @endphp
                                @endif
                                <textarea name="order_note" class="form-control h-100" cols="30" rows="10" placeholder="{{ ORDER_NOTES }}">{{ $temp_var }}</textarea>
                            </div>
                        </div>
