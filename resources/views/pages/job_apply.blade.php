...
@section('content')
    <div class="page-banner" style="background-image: url({{ asset('public/uploads/'.$g_setting->banner_job_application) }})">
        ...
        <div class="text">
            <h1>{{ APPLY_FOR }}: {{ $job_detail->job_title }}</h1>
                            ...
                            <div class="type-3">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger">({{ ALLOW_DOC_DOCX_PDF }})</span>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div>
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck1">{{ AGREEMENT_TEXT }}</label>
                                            </div>
                                        </div>
                                    </div>
