                ...
                <div class="col-md-8">
                    <div class="single-section">
                        ...
                        <div class="share_buttons">
                            ...
                            <a class="linkedin" target="_blank" href="https://www.linkedin.com/sharing/share-offsite/?url={{ url('blog/'.$blog_detail->blog_slug) }}"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                                ...
                                @foreach($comments as $row)
                                    <div class="comment-item">
                                        <div class="text">
                                            ...
                                            <div class="des">
                                                <p>
                                                    {!! clean(nl2br($row->person_message)) !!}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
