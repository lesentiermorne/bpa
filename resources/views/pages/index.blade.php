    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 wow fadeInLeft">
                ...
                <p>
                    {!! clean(nl2br($page_home->special_content)) !!}
                </p>
                <div class="read-more">
                ...
                <div class="project-carousel owl-carousel">
                    ...
                    <div class="project-item wow fadeInUp">
                        ...
                        <div class="text">
                            ...
                            <p>
                                {!! clean(nl2br($row->project_content_short)) !!}
                            </p>
                            <div class="read-more">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="cta-box text-center">
                    ...
                    <p class="mt-3">
                        {!! clean(nl2br($page_home->appointment_text)) !!}
                    </p>
        ...
        <div class="row">
            <div class="col-md-12 newsletter">
                <div class="newsletter-text wow fadeInUp">
                    ...
                    <p>
                        {!! clean(nl2br($page_home->newsletter_text)) !!}
                    </p>
                </div>
