...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Website Section -->
        <li class="nav-item @if($conName[1] == 'slider' || $conName[1] == 'project' || $conName[1] == 'photo-gallery' || $conName[1] == 'video-gallery' || $conName[1] == 'why-choose' || $conName[1] == 'service' || $conName[1] == 'testimonial' || $conName[1] == 'team-member' || $conName[1] == 'faq' || $conName[1] == 'social-media') active @endif">
            ...
            <div id="collapseWebsite" class="collapse @if($conName[1] == 'slider' || $conName[1] == 'project' || $conName[1] == 'photo-gallery' || $conName[1] == 'video-gallery' || $conName[1] == 'why-choose' || $conName[1] == 'service' || $conName[1] == 'testimonial' || $conName[1] == 'team-member' || $conName[1] == 'faq' || $conName[1] == 'social-media') show @endif" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
