                        ...
                        <ul>
                            @if(!session()->get('customer_id'))
                                ...
                                <li class="login_top_menu">
                                    <a href="{{ route('customer.login') }}">{{ TOP_BAR_LOGIN }}</a>
                                </li>
                                @endif

                                @if($g_setting->top_bar_registration_status == 'Show')
                                <li class="registration_top_menu">
                                    <a href="{{ route('customer.registration') }}">{{ TOP_BAR_REGISTRATION }}</a>
                                </li>
                                @endif
                            ...
                            @if(session()->get('customer_id'))
                            <li class="registration_top_menu">
                                <a href="{{ route('customer.dashboard') }}">{{ TOP_BAR_DASHBOARD }}</a>
                            </li>
                            @endif
                            ...
                            <li class="cart">
                                <a href="{{ route('front.cart') }}">{{ TOP_BAR_CART }} </a>
        ...
        <div class="row footer-end">
            ...
            <div class="col-md-6">
                <div class="footer-pages">
                    <ul>
                        <li><a href="{{ route('front.term') }}">{{ FOOTER_TERMS_AND_CONDITIONS }}</a></li>
                        <li><a href="{{ route('front.privacy') }}">{{ FOOTER_PRIVACY_POLICY }}</a></li>
                    </ul>
                </div>
            </div>
        </div>
